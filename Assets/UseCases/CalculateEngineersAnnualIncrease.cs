...
namespace UseCases
{
    public class CalculateEngineersAnnualIncrease : ICalculateAnnualIncrease
    {
        private const int SrBaseSalary = 5_000;
        private const int SsrBaseSalary = 3_000;
        private const int JrBaseSalary = 1_500;
        
        private const double SrAnnualIncrease = 0.1;
        private const double SsrAnnualIncrease = 0.07;
        private const double JrAnnualIncrease = 0.05;

        private readonly ISalaryRepository _salarySalaryRepository;

        public CalculateEngineersAnnualIncrease(ISalaryRepository salaryRepository)
        {
